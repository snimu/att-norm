...
def make_run_name(settings: dict[str, Any]) -> str:
    ...
    name += f"_qk.{settings['qk_activ']}" if settings['qk_activ'] != "none" else ""
    name += f"_qk.{settings['qk_norm']}" if settings['qk_norm'] != "none" else ""
    name += f"_attn.{settings['attn_activ']}" if settings['attn_activ'] != "none" else ""
    name += f"_attn.{settings['post_attn_norm']}" if settings['post_attn_norm'] != "none" else ""
