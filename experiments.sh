...
python main.py -c --logfile results2.csv -w --wandb_project att-norm.2 --qk_activ none --qk_norm fro_norm rms_norm none --attn_activ softmax sigmoid --post_attn_norm rms_norm none --num_runs 5 --seed 12345 --depth 21 --width 1024